defmodule SuretrustdiagnosticsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SuretrustdiagnosticsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SuretrustdiagnosticsWeb.Gettext, "errors", msg, opts)
    end
  end
